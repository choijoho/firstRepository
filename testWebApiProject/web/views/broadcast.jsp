...
<body>
	...
	<div id="chatbox" style="display:none;">
		<fieldset style="display:inline-block; width:65%; background:lightgray;">
		   ...
		   <textarea id="inputMessage" rows="4" style="width:50%; resize: none;" onkeyup="enterKey()"></textarea>
	...
	function connection(){
		webSocket = new WebSocket('ws://192.168.20.31:8088'+
